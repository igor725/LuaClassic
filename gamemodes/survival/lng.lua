...
MESG_PVP           = 'Enable PvP mode first (/pvp)'
MESG_PPVP          = 'This player is not in pvp mode'
MESG_DROP          = '%d %s received from &a%s'

SURV_OXYGEN        = 'Oxygen: %.1f'
SURV_KILL          = 'Player %s killed by %s.'
SURV_MINING        = 'Mining block: %d%%...'
SURV_NOT_HUNGRY    = 'You\'re not hungry'
