...
CON_SAVESUCC       = '&aConfiguration saved successfully'
CON_HELP           = '&aFor help, type "help" or "?"'
CON_START          = 'Starting LuaClassic server...'
CON_SAVEERR        = '&cConfiguration save failed!'
CON_BINDSUCC       = '&aServer started on %s:%d%s'
CON_WSBINDSUCC     = ' (websocket port: %d)'
CON_WLOADERR       = '&cNo worlds loaded'
CON_WSAVE          = 'Saving worlds:'
CON_SVSTOP         = '&4Server stopped'
...
CMD_TIMECHANGE     = '&aTime changed to %s'
