...
time_presets = {
	night = {
		[EC_DIFFUSE] = newColor(0x80, 0x80, 0x80),
		[EC_AMBIENT] = newColor(0x30, 0x30, 0x30),
		[EC_FOG]     = newColor(0x20, 0x20, 0x40),
		[EC_CLOUD]   = newColor(0x40, 0x40, 0x40),
		[EC_SKY]     = newColor(0x15, 0x15, 0x30)
	},
	dawn = {
		[EC_DIFFUSE] = newColor(0xA0, 0x90, 0x80),
		[EC_AMBIENT] = newColor(0x40, 0x30, 0x30),
